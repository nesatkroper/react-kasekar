    ...
    <Card className="w-full">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex border-b">
          <button
            className={`px-4 py-2 flex items-center gap-2 ${activeTab === "upload" ? "border-b-2 border-primary font-medium" : "text-muted-foreground"
              }`}
          ...
          <button
            className={`px-4 py-2 flex items-center gap-2 ${activeTab === "camera" ? "border-b-2 border-primary font-medium" : "text-muted-foreground"
              }`}
