...
import { ArrowUpDown, Calendar, MoreHorizontal, ArrowUpRight, ArrowDownLeft } from "lucide-react"
        ...
        cell: ({ row }) => {
            ...
            return (
                <div className="flex items-center gap-2">
                    <div
                        className={`h-6 w-6 rounded-full flex items-center justify-center ${type === "in" ? "bg-green-100 text-green-600" : "bg-red-100 text-red-600"}`}
                    >
                        {type === "in" ? <ArrowDownLeft className="h-3 w-3" /> : <ArrowUpRight className="h-3 w-3" />}
                    </div>
                    <Badge variant={type === "in" ? "default" : "destructive"} className="capitalize">
    ...
    },
    {
        ...
        cell: ({ row }) => (
            <div>
                ...
                <div className="text-xs text-muted-foreground mt-1">{row.original.referenceId}</div>
            </div>
        ),
    },
    {
            ...
            return (
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end" className="w-[160px]">
                        ...
                        <DropdownMenuItem onClick={() => navigator.clipboard.writeText(movement.movementId)}>
                            Copy movement ID
                        </DropdownMenuItem>
                        <DropdownMenuSeparator />
