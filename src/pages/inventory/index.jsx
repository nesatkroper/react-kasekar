            ...
            <div className="flex-1 space-y-6 p-6 md:p-8 pt-6">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div>
                        ...
                        <p className="text-muted-foreground mt-1">Manage your products, stock levels, and inventory movements</p>
                    </div>
                ...
                <div className="mt-6">
                    <Tabs defaultValue="overview" className="space-y-6" value={activeTab} onValueChange={setActiveTab}>
                            ...
                            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-7">
                                <Card className="col-span-4">
                                    <CardContent className="p-6">
                                        ...
                                        <p className="text-sm text-muted-foreground mb-6">Stock levels across all product categories</p>
                                        <Overview />
                                    </CardContent>
                                </Card>
                                <Card className="col-span-3">
                                    <CardContent className="p-6">
                                        ...
                                        <p className="text-sm text-muted-foreground mb-6">Latest product movements in your inventory</p>
                        ...
                        <TabsContent value="products" className="space-y-6 mt-6">
                            <Card>
                                <CardContent className="p-6">
                                    <h3 className="text-lg font-medium mb-4">Products Inventory</h3>
                                    <p className="text-sm text-muted-foreground mb-6">Manage your product catalog and stock levels</p>
                        ...
                        <TabsContent value="stock" className="space-y-6 mt-6">
                            <Card>
                                <CardContent className="p-6">
                                    ...
                                    <p className="text-sm text-muted-foreground mb-6">Track all stock additions and inventory updates</p>
